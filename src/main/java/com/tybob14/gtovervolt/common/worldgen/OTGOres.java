...
public class OTGOres extends GTOres {
    public static final GTOreDefinition URANIUM_238_VEIN = create(GTOvervolt.id("uranium_238_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(20).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.DEIMOS.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.CERES.location(), GTOVDimensions.GANYMEDE.location(), GTOVDimensions.ENCELADUS.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(20, 30).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition PLUTONIUM_239_VEIN = create(GTOvervolt.id("plutonium_239_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(5).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.CALLISTO.location(), GTOVDimensions.CERES.location(), GTOVDimensions.GANYMEDE.location(), GTOVDimensions.IO.location()).heightRangeUniform(5, 40).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition SULFUR_VEIN = create(GTOvervolt.id("sulfur_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(90).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.NETHER.location(), GTOVDimensions.DEIMOS.location(), GTOVDimensions.MARS.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.IO.location(), GTOVDimensions.VENUS.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.ANUBIS.location()).heightRangeUniform(5, 20).layeredVeinGenerator((generator) -> {
    ...
    public static final GTOreDefinition DIAMOND_VEIN = create(GTOvervolt.id("diamond_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(30).heightRangeUniform(-55, -30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.GANYMEDE.location(), GTOVDimensions.MERCURY.location(), GTOVDimensions.MIRANDA.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDF.location()).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition INFINITY_CATALYST_VEIN = create(GTOvervolt.id("infinity_catalyst_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(15).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.ANUBIS.location()).heightRangeUniform(-60, -40).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition LAPIS_VEIN = create(GTOvervolt.id("lapis_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(40, 52)).density(0.75F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), Level.END.location(), GTOVDimensions.DEIMOS.location(), GTOVDimensions.CERES.location(), GTOVDimensions.ENCELADUS.location(), GTOVDimensions.VEGA_B.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(-60, 10).dikeVeinGenerator((generator) -> {
    ...
    public static final GTOreDefinition VERMICULITE_VEIN = create(GTOvervolt.id("vermiculite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(80).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location()).heightRangeUniform(80, 200).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition OILSANDS_VEIN = create(GTOvervolt.id("oilsands_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.3F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.T_CETI_E.location()).heightRangeUniform(30, 80).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
    ...
    public static final GTOreDefinition MAGNESITE_VEIN = create(GTOvervolt.id("magnesite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(50, 64)).density(0.75F).weight(100).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.EUROPA.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.HORUS.location()).heightRangeUniform(55, 65).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition OLIVINE_VEIN = create(GTOvervolt.id("olivine_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), Level.END.location(), GTOVDimensions.CERES.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(-20, -45).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition OSMIUM_VEIN = create(GTOvervolt.id("osmium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.2F).weight(5).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.ENCELADUS.location(), GTOVDimensions.MIRANDA.location(), GTOVDimensions.OBERON.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.MEHEN_BELT.location(), GTOVDimensions.SETH.location()).heightRangeUniform(5, 40).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition TUNGSTEN_VEIN = create(GTOvervolt.id("tungsten_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.2F).weight(15).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.OBERON.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.TRITON.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(-10, -35).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition COAL_VEIN = create(GTOvervolt.id("coal_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.25F).weight(70).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location()).heightRangeUniform(10, 140).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition MANGANESE_VEIN = create(GTOvervolt.id("manganese_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(50, 64)).density(0.75F).weight(10).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), Level.NETHER.location(), Level.END.location()).heightRangeUniform(20, 30).dikeVeinGenerator((generator) -> {
    ...
    public static final GTOreDefinition DESH_VEIN = create(GTOvervolt.id("desh_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.2F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.MARS.location(), GTOVDimensions.MIRANDA.location(), GTOVDimensions.ANUBIS.location()).heightRangeUniform(-10, -35).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition CERTUS_QUARTZ_VEIN = create(GTOvervolt.id("certus_quartz_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.HORUS.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(40, 80).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition QUARTZITE = create(GTOvervolt.id("quartzite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(20).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.NETHER.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(80, 120).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(NETHER_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition SAMARIUM = create(GTOvervolt.id("samarium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(10).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.BARNARDC.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.SETH.location()).heightRangeUniform(-63, -50).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition PITCHBLENDE_VEIN = create(GTOvervolt.id("pitchblende_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 64)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.MARS.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.IO.location(), GTOVDimensions.VENUS.location(), GTOVDimensions.OBERON.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(30, 60).cuboidVeinGenerator((generator) -> {
            generator.top((b) -> {
    ...
    public static final GTOreDefinition REDSTONE_VEIN = create(GTOvervolt.id("redstone_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(50).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), Level.NETHER.location(), GTOVDimensions.MARS.location(), GTOVDimensions.GANYMEDE.location(), GTOVDimensions.MERCURY.location(), GTOVDimensions.VENUS.location(), GTOVDimensions.MIRANDA.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(-65, -10).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition SAPPHIRE_VEIN = create(GTOvervolt.id("sapphire_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(50).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.HORUS.location()).heightRangeUniform(-40, 0).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition PYROLUSITE_VEIN = create(GTOvervolt.id("pyrolusite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.IO.location(), GTOVDimensions.MIRANDA.location()).heightRangeUniform(20, 30).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NAQUADRIA_VEIN = create(GTOvervolt.id("naquadria_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(48, 80)).density(0.25F).weight(40).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.MAAHES.location()).heightRangeUniform(10, 90).cuboidVeinGenerator((generator) -> {
            generator.top((b) -> {
    ...
    public static final GTOreDefinition MICA_VEIN = create(GTOvervolt.id("mica_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(10).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(-40, -10).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition CRYOLITE_VEIN = create(GTOvervolt.id("cryolite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.MAAHES.location()).heightRangeUniform(-20, -35).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition INFUSED_GOLD_VEIN = create(GTOvervolt.id("infused_gold_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.15F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.IO.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(-10, 10).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition DOLOMITE = create(GTOvervolt.id("dolomite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(50).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(150, 200).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition BLACK_PLUTONIUM_VEIN = create(GTOvervolt.id("black_plutonium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(40).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.HORUS.location()).heightRangeUniform(-60, -40).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition RARE_EARTH_VEIN = create(GTOvervolt.id("rare_earth_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(40).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.BARNARDE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(20, 40).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NICKEL_VEIN = create(GTOvervolt.id("nickel_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), Level.END.location(), GTOVDimensions.DEIMOS.location(), GTOVDimensions.MARS.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.VENUS.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.TRITON.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(-10, 60).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition THORIUM_VEIN = create(GTOvervolt.id("thorium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.TRITON.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(-20, 5).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition ARSENIC_VEIN = create(GTOvervolt.id("arsenic_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.MARS.location(), GTOVDimensions.PHOBOS.location(), GTOVDimensions.MERCURY.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.VEGA_B.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(0, 50).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition VANADIUM_VEIN = create(GTOvervolt.id("vanadium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.3F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.ENCELADUS.location(), GTOVDimensions.PROTEUS.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.VEGA_B.location(), GTOVDimensions.MAAHES.location()).heightRangeUniform(10, 50).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition SOAPSTONE_VEIN = create(GTOvervolt.id("soapstone_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.CERES.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.MAAHES.location()).heightRangeUniform(0, 50).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NEUTRONIUM_VEIN = create(GTOvervolt.id("neutronium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(40).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.PROTEUS.location(), GTOVDimensions.TRITON.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.KUIPER_BELT.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.VEGA_B.location(), GTOVDimensions.MAAHES.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(-60, -40).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
                b.mat(GTMaterials.Neutronium).size(4);
            }).secondary((b) -> {
                b.mat(PrimaryMaterials.Adamantium).size(3);
    ...
    public static final GTOreDefinition KAOLINITE = create(GTOvervolt.id("kaolinite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.15F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(10, 60).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NETHER_STAR_VEIN = create(GTOvervolt.id("nether_star_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.HAUMEA.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.VEGA_B.location(), GTOVDimensions.HORUS.location()).heightRangeUniform(-50, -30).classicVeinGenerator((generator) -> {
            generator.primary((b) -> {
    ...
    public static final GTOreDefinition BERYLLIUM_VEIN = create(GTOvervolt.id("beryllium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(50, 64)).density(0.75F).weight(20).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.END.location(), Level.NETHER.location(), GTOVDimensions.MARS.location(), GTOVDimensions.CERES.location(), GTOVDimensions.VENUS.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.HAUMEA.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.PLUTO.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.A_CENTAURI_BB.location()).heightRangeUniform(5, 30).dikeVeinGenerator((generator) -> {
    ...
    public static final GTOreDefinition ELECTROTINE_VEIN = create(GTOvervolt.id("electrotine_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(30).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.NETHER.location(), GTOVDimensions.CERES.location(), GTOVDimensions.A_CENTAURI_BB.location()).heightRangeUniform(5, 45).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(NETHER_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition LIGNITE_COAL_VEIN = create(GTOvervolt.id("lignite_coal_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.25F).weight(70).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.BARNARDC.location()).heightRangeUniform(10, 140).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition PLATINUM_VEIN = create(GTOvervolt.id("platinum_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.2F).weight(5).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.END.location(), GTOVDimensions.MAAHES.location(), GTOVDimensions.MEHEN_BELT.location()).heightRangeUniform(5, 50).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(END_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NIOBIUM_VEIN = create(GTOvervolt.id("niobium_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(25, 29)).density(0.25F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.TRITON.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDF.location(), GTOVDimensions.VEGA_B.location()).heightRangeUniform(-30, 10).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition APATITE_VEIN = create(GTOvervolt.id("apatite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.25F).weight(60).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.T_CETI_E.location()).heightRangeUniform(10, 80).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition RUTILE_VEIN = create(GTOvervolt.id("rutile_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.3F).weight(10).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.VENUS.location(), GTOVDimensions.TITAN.location(), GTOVDimensions.ANUBIS.location()).heightRangeUniform(-10, 20).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition MINERAL_SAND_VEIN = create(GTOvervolt.id("mineral_sand_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(70).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.EUROPA.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.ANUBIS.location(), GTOVDimensions.MAAHES.location()).heightRangeUniform(15, 60).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition CHROME_VEIN = create(GTOvervolt.id("chrome_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.3F).weight(10).layer(OVWorldGenLayers.ALL_DIM).dimensions(GTOVDimensions.EUROPA.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.MAAHES.location()).heightRangeUniform(-10, 20).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition MAGNETITE_VEIN = create(GTOvervolt.id("magnetite_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.15F).weight(120).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.DEIMOS.location(), GTOVDimensions.CERES.location(), GTOVDimensions.IO.location(), GTOVDimensions.MAKEMAKE.location(), GTOVDimensions.BARNARDE.location(), GTOVDimensions.T_CETI_E.location(), GTOVDimensions.SETH.location()).heightRangeUniform(10, 60).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
                    l.weight(3).mat(GTMaterials.Magnetite).size(2, 4);
                }).layer((l) -> {
    ...
    public static final GTOreDefinition TIN_VEIN = create(GTOvervolt.id("tin_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(38, 44)).density(0.15F).weight(80).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.EUROPA.location(), GTOVDimensions.A_CENTAURI_BB.location()).heightRangeUniform(20, 60).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition SALTS_VEIN = create(GTOvervolt.id("salts_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(40).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.OVERWORLD.location(), GTOVDimensions.MARS.location(), GTOVDimensions.BARNARDC.location(), GTOVDimensions.T_CETI_E.location()).heightRangeUniform(30, 70).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(OVERWORLD_RULES).layer((l) -> {
    ...
    public static final GTOreDefinition NETHER_QUARTZ_VEIN = create(GTOvervolt.id("nether_quartz_vein"), (vein) -> {
        vein.clusterSize(UniformInt.of(32, 40)).density(0.2F).weight(70).layer(OVWorldGenLayers.ALL_DIM).dimensions(Level.NETHER.location(), GTOVDimensions.A_CENTAURI_BB.location(), GTOVDimensions.NEPER.location()).heightRangeUniform(40, 80).layeredVeinGenerator((generator) -> {
            generator.withLayerPattern(() -> {
                return GTLayerPattern.builder(NETHER_RULES).layer((l) -> {
