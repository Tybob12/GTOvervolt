...
public class OreMaterials {
    ...
    public static void modifyMaterials() {
        ...
        Naquadria.setProperty(PropertyKey.ORE, new OreProperty());
        ...
        Neutronium.setProperty(PropertyKey.ORE, new OreProperty());
        ...
        Chromium.setProperty(PropertyKey.ORE, new OreProperty());
        ...
        Plutonium241.setProperty(PropertyKey.ORE, new OreProperty());
        Uranium235.setProperty(PropertyKey.ORE, new OreProperty());
        Manganese.setProperty(PropertyKey.ORE, new OreProperty());
        Trinium.setProperty(PropertyKey.ORE, new OreProperty());
